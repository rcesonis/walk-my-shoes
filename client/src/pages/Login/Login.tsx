        ...
        <div className="p-8 md:p-20 flex flex-col justify-center">
          ...
          <div className="flex justify-center">
            <a
              ...
              className="flex text-xs font-medium text-white items-center justify-center bg-customLightBlue hover:bg-customBlue active:bg-customLightBlue w-full py-2 rounded transition duration-200"
            >
